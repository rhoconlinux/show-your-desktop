...
mkdir -p ~/.show-your-desktop-install && cd ~/.show-your-desktop-install && wget https://github.com/rhoconlinux/show-your-desktop/archive/master.zip && unzip master.zip 
